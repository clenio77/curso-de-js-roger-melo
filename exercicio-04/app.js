...
const my3FavoriteTVShows = ['Transformers', 'iron-man','Vingadores']
const sentence = `Minhas 3 series favoritas são: ${my3FavoriteTVShows.join(', ' )}`.replace(', V',' e V')
...
*/
numberCaracters = 39
//console.log(`A string que a "typeSentence" armazena tem mais de ${numberCaracters} caracteres? ${String(typeSentence.length > numberCaracters).replace('t','T')}`)
...
//console.log(`Todos os ${falsyValues.length} itens do arrays "falsyValues" são falsy. Inclusive o ${falsyValues[2]}`)
